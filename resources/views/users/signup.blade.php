    ...
    <div class="flex h-screen place-content-center bg-white ">
        <div>
            ...
            <div class="absolute top-32 text-white px-4 pt-32 text-center">
                ...
                <a class=" bg-verde border p-1 px-6 text-white border-verde_azul font-lora" href="{{ route('login') }}">Iniciar Sesión</a>
            </div>
        </div>

        <div class="col-span-2 m-24 ">
            <h1 class="font-bold text-4xl m-8 text-center pb 8 font-lora text-azul">Registrarse</h1>
