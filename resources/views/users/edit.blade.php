<x-layout>
    <section class="flex justify-center ml-24 my-3 border-2 border-double border-brown mr-24">
        <div class="card profile-widget">
            ...
            <form action="/logout" method="POST">
                @csrf
                <a href="#" onclick="this.closest('form').submit()" class=" bg-light-green border p-1 px-6 text-white border-light-green">
                    cerrar sessión
                </a>
            </form>
        </div>
    ...
    @if ($user->is_seller)
        ...
        <section class="flex justify-center ">
            ...
            <form class="flex justify-center items-center pl-10" action="{{ route('users.edit.update') }}" method="POST">
                @csrf
                <div class="w-96 p-6">
                    <div>
