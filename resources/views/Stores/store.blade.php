            ...
            <div class="flex h-screen place-content-center bg-white">
                <div class="w-96">
                    <img class="h-screen w-96"
                        src="{{ asset('https://img.freepik.com/premium-photo/natural-skincare-cosmetics-bottles-products-with-green-plant-vertical-background-with-copy-space-beauty-skin-care-herbal-organic-product-deep-hydration-soothing-ai-generative-content_70898-10769.jpg') }}"
                        alt="">
                </div>
                <div class="col-span-2 m-8 h-2" style="color: #283618">
                    ...
                    <form class="flex justify-center items-center " action="store" method="POST">
                        @csrf
                        <div class="w-96 p-3">
                            ...
                            <div>
                                ...
                                <div class="flex justify-center">
                                    <button
                                        style="width: 150px; padding: 10px; margin: 10px 0;  cursor: pointer; color: #FEFAE0; background-color: #606c38;" type="submit">Enviar</button>
                                </div>
                            </div>
                    </form>
                </div>
