<x-layout>
    <section class="text-center">
        ...
        <img height="50px" width="50px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Adidas_Logo.svg/2560px-Adidas_Logo.svg.png" alt="">
            ...
            <input class=" bg-light-brown w-4/5 h-10 placeholder-white text-2xl font-serif " type="text" placeholder="Buscar">
            <section>
    ...
    <section class="grid grid-cols-2 content-center">
        ...
        <div>
            <img height="350px" width="350px"
                src="https://i.etsystatic.com/31443243/r/il/989c0f/3906202515/il_570xN.3906202515_alu2.jpg"
                alt="">
        </div>
        ...
        <button class="border-double border-neutral-950 border rounded-xl px-20 py-5 color-background: bg-light-green"
            type="submit">Registrarse</button>
            <div>

            </div>
        <button class="px-20 py-5 type=submit">Iniciar sesión</button>
        </div>
