<x-layout>
    ...
    <header class="flex justify-between items-center bg-[#829540] p-6 text-white">
        ...
        <a href="#" class="flex items-center text-lg font-semibold">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-1 5h13m-1-5l1-5m-5 10a1 1 0 110 2 1 1 0 010-2zm-6 0a1 1 0 110 2 1 1 0 010-2z" />
                <circle cx="8.5" cy="21" r="2" />
                <circle cx="16.5" cy="21" r="2" />
            </svg>
        </a>
    </header>
    ...
    <div class="max-w-screen-xl mx-auto px-4 py-8">
        <div class="flex items-center space-x-8">
            ...
            <!-- Imagen principal -->
            <div class="w-1/2">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrSy57tnkq38zr5EvxJUsFOy5mt7kFD545iZCVOdI9a3uQ5ZO9" alt="Imagen de producto" class="w-full max-w-full rounded-lg shadow-md">
            </div>
            
            <!-- Información de producto -->
            <div class="w-1/2">
                <div class="text-left">
                    <p class="text-2xl font-bold mb-4">Cepillos dentales</p>
                    <div class="text-lg text-gray-600">
                        <p>Cepillos de bambú</p>
                        <p>$4.25</p>
